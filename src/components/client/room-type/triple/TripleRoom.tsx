          ...
          <Row>
            <Col xs={24} sm={24} md={12} span={12}>
              <div>
                <h2>Phòng Ba</h2>
                <p>
                  Phòng ba tại ký túc xá Trường Đại học Văn Lang là một lựa chọn
                  lý tưởng cho sinh viên đang tìm kiếm một không gian sống thuận
                  tiện và thoải mái.
                </p>
              </div>
              <div>
                <p>3 GIƯỜNG ĐƠN 180x160</p>
              ...
              <div className="common-questions-container">
                ...
                <div className="common-questions-content">
                  <AnswerButton
                    ...
                    answer="Ký Túc Xá cung cấp nhiều loại phòng, bao gồm phòng ba, phòng đôi, phòng ba, và phòng sáu với các tiện nghi đầy đủ."
                  />
                </div>
                <div className="common-questions-content">
                  <AnswerButton
